INSERT INTO location (name, addressDTO, postal_code, country, state, city)
VALUES ('AMC Empire 25', '234 W 42nd St', '10036', 'United States', 'New York', 'New York'),
...
INSERT INTO cinema (name, sponsored_name, location_id)
VALUES ('Hall 1 - EMPIRE', 'McDonald', (SELECT l.id from location l WHERE l.name = 'AMC Empire 25')),
...
INSERT INTO movie (duration, name, price, release_date, state, summary, type)
...
INSERT INTO movie_cinema (date_time, cinema_id, movie_id)
VALUES ('2020-12-05 20:00:00', (SELECT c.id FROM cinema c WHERE c.name = 'Hall 1 - EMPIRE'),
        (SELECT m.id FROM movie m WHERE m.name = 'The Gentleman')),
       ...
       ('2020-12-06 20:00:00', (SELECT c.id FROM cinema c WHERE c.name = 'Hall 1 - EMPIRE'),
        (SELECT m.id FROM movie m WHERE m.name = 'Tenet')),
       ...
       ('2020-12-08 18:00:00', (SELECT c.id FROM cinema c WHERE c.name = 'Hall 4 - SQUARE 13'),
        (SELECT m.id FROM movie m WHERE m.name = 'The Godfather')),
...
INSERT INTO account_details (addressDTO, age, city, country, name, postal_code, role, state)
VALUES ('262  Lochmere Lane', 35, 'LOUISVILLE', 'United States', 'Josie D Story', '40289', 'USER', 'Kentucky'),
...
INSERT INTO user_account (email, password, username, account_details_id)
VALUES ('josie_story@email.com', '123123123', 'josieStory', (SELECT id from account_details WHERE name = 'Josie D Story')),
...
VALUES ('2020-12-05 20:00:00', 14, 15, (SELECT id
       ...
       (SELECT id from user_account WHERE email = 'josie_story@email.com')),
