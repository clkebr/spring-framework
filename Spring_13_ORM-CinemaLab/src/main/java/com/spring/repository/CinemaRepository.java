...
import com.spring.entity.Cinema;
...
public interface CinemaRepository extends JpaRepository<Cinema, Long> {
    ...
    List<Cinema> findFirst3BySponsoredNameContainingOrderBySponsoredName(String sponsored);
    ...
    List<Cinema> fetchByPattern(@Param("pattern") String pattern);
    ...
    List<String> distinctBySponsored();
}
