...
//    @Pointcut("execution(* com.spring.controller.CourseController.*(..))")
...
//    @Before("execution(* com.spring.controller.CourseController.*(..))")
//    public void beforeAdvice(){
//        logger.info("Logger info ------");
//    }

//    @Pointcut("execution(* com.spring.repository.CourseRepository.findById(*))")
...
//    //within
//    @Pointcut("within(com.spring.controller..*)")
...
//    }
    ...
    @Pointcut("@annotation(com.spring.annotation.Loggable)")
